...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><circle cx="13.97" cy="6.17" r="1.95" fill="var(--cut)"></circle><path d="M10 11L14.42 11" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"></path><path d="M10 11L13.97 6.17" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"></path><path d="M10 11L7.38 8.38" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"></path><path d="M10 11L5.58 11" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"></path><path d="M10 11L10 15.82" stroke="currentColor" stroke-width="1.1" stroke-linecap="round" fill="none"></path><circle cx="10" cy="11" r="1.89" fill="currentColor"></circle><circle cx="14.42" cy="11" r="1.31" fill="currentColor"></circle><circle cx="13.97" cy="6.17" r="1.45" fill="currentColor"></circle><circle cx="7.38" cy="8.38" r="0.95" fill="currentColor"></circle><circle cx="5.58" cy="11" r="1.31" fill="currentColor"></circle><circle cx="10" cy="15.82" r="1.31" fill="currentColor"></circle></svg>',
