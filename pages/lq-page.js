...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><path d="M13.93 7.07L15.37 5.63" stroke="var(--cut)" stroke-width="3.28" fill="none" stroke-linecap="butt"></path><circle cx="15.37" cy="5.63" r="3.3" fill="var(--cut)"></circle><path d="M10 11L15.37 5.63" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" fill="none"></path><path d="M10 11L5.85 9.89" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" fill="none"></path><path d="M10 11L11.11 15.15" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" fill="none"></path><circle cx="15.37" cy="5.63" r="2.1" fill="currentColor"></circle><circle cx="5.85" cy="9.89" r="2.1" fill="currentColor"></circle><circle cx="11.11" cy="15.15" r="2.1" fill="currentColor"></circle></svg>',
