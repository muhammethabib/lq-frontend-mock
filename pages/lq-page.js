...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><path d="M16.15 3.74L12.69 5.71" stroke="var(--cut)" stroke-width="2.35" fill="none" stroke-linecap="butt"></path><path d="M17.26 4.85L15.29 8.31" stroke="var(--cut)" stroke-width="2.35" fill="none" stroke-linecap="butt"></path><path d="M7.6 8.6L12.4 13.4" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" fill="none"></path><path d="M18.7 2.3L7.6 8.6" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" fill="none"></path><path d="M18.7 2.3L12.4 13.4" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" fill="none"></path><circle cx="7.6" cy="8.6" r="2.1" fill="currentColor"></circle><circle cx="12.4" cy="13.4" r="2.1" fill="currentColor"></circle><circle cx="18.7" cy="2.3" r="2.1" fill="currentColor"></circle></svg>',
