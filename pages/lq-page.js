...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><path d="M14.41 7.61L17.22 5.46" stroke="var(--cut)" stroke-width="2.88" fill="none" stroke-linecap="butt"></path><circle cx="17.22" cy="5.46" r="3.3" fill="var(--cut)"></circle><path d="M12.2 9.3L17.22 5.46" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"></path><path d="M12.2 9.3L8.37 7.72" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"></path><path d="M12.2 9.3L12.75 13.42" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"></path><circle cx="17.22" cy="5.46" r="2.1" fill="currentColor"></circle><circle cx="8.37" cy="7.72" r="2.1" fill="currentColor"></circle><circle cx="12.75" cy="13.42" r="2.1" fill="currentColor"></circle></svg>',
