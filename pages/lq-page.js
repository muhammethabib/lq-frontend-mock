...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><path d="M10 11L13.68 11" stroke="currentColor" stroke-width="1.05" stroke-linecap="round" fill="none"></path><path d="M10 11L13.02 7.32" stroke="currentColor" stroke-width="1.05" stroke-linecap="round" fill="none"></path><path d="M10 11L7.82 8.82" stroke="currentColor" stroke-width="1.05" stroke-linecap="round" fill="none"></path><path d="M10 11L6.32 11" stroke="currentColor" stroke-width="1.05" stroke-linecap="round" fill="none"></path><path d="M10 11L10 15.02" stroke="currentColor" stroke-width="1.05" stroke-linecap="round" fill="none"></path><circle cx="10" cy="11" r="1.8" fill="currentColor"></circle><circle cx="13.68" cy="11" r="1.25" fill="currentColor"></circle><circle cx="13.02" cy="7.32" r="1.25" fill="currentColor"></circle><circle cx="7.82" cy="8.82" r="0.9" fill="currentColor"></circle><circle cx="6.32" cy="11" r="1.25" fill="currentColor"></circle><circle cx="10" cy="15.02" r="1.25" fill="currentColor"></circle></svg>',
