...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><path d="M15.81 3.5L11.99 5.34" stroke="var(--cut)" stroke-width="2.35" fill="none" stroke-linecap="butt"></path><path d="M17.5 5.19L15.66 9.01" stroke="var(--cut)" stroke-width="2.35" fill="none" stroke-linecap="butt"></path><path d="M6.82 7.82L13.18 14.18" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" fill="none"></path><path d="M19.05 1.95L6.82 7.82" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" fill="none"></path><path d="M19.05 1.95L13.18 14.18" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" fill="none"></path><circle cx="6.82" cy="7.82" r="1.7" fill="currentColor"></circle><circle cx="13.18" cy="14.18" r="1.7" fill="currentColor"></circle><circle cx="19.05" cy="1.95" r="1.7" fill="currentColor"></circle></svg>',
    ...
    v1: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><circle cx="10" cy="11" r="2.4" fill="currentColor"></circle></svg>',
  ...
  function group(id, label, items, keys, year, icon) {
    ...
    return '<button type="button" class="side-link side-link-parent" id="' + id + 'Toggle" aria-expanded="' + open + '" aria-controls="' + id + '">' +
      (icon || ICON.v3) + '<span>' + esc(label) + '</span>' + yearTag(year) + ICON.chev + '</button>' +
    ...
    var html =
      ...
      '<nav class="side-menu" id="sideMenu" aria-label="' + T.menu + '" aria-hidden="true">' +
        ...
        '<div class="side-nav">' +
          ...
          group('lqSub3', T.lq3, sublink('v3about', T.v3about, href('v3about')) + sublink('v3brochure', T.v3brochure, href('v3brochure')), ['v3about', 'v3brochure'], '2026', ICON.v3) +
