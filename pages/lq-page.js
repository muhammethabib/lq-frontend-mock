...
(function () {
  ...
  var ICON = {
    ...
    v3: '<svg viewBox="0 0 24 24"><circle cx="10" cy="11" r="9" fill="currentColor"></circle><circle cx="10" cy="11" r="6.4" fill="var(--cut)"></circle><path d="M16.4 17.4l4.4 4.4" stroke="currentColor" stroke-width="3.6" stroke-linecap="round" fill="none"></path><path d="M15.85 3.53L12.06 5.37" stroke="var(--cut)" stroke-width="2.4" fill="none" stroke-linecap="butt"></path><path d="M17.47 5.15L15.63 8.94" stroke="var(--cut)" stroke-width="2.4" fill="none" stroke-linecap="butt"></path><path d="M19.02 1.98L6.89 7.89" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"></path><path d="M19.02 1.98L13.11 14.11" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"></path><circle cx="6.89" cy="7.89" r="1.75" fill="currentColor"></circle><circle cx="13.11" cy="14.11" r="1.75" fill="currentColor"></circle><circle cx="19.02" cy="1.98" r="1.75" fill="currentColor"></circle></svg>',
